public class exo3 {
    ...
    class batiment {
        ...
        public String toString() {
            ...
            System.out.println("adress batimat: "+adress);
    ...
    class Immeuble extends batiment {
        ...
        public String toString() {
            ...
            System.out.println("adress batimat: "+getb()+" nbr des chembers sont "+getnbch()+" et le nbr des immeuble sont "+nbImmeuble);
    ...
    class maison extends batiment {
        ...
        public String toString() {
            ...
            System.out.println("adress batimat: "+getb()+" nbr des chembers sont "+nbChambres);
